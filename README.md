...
A Poke App Which is made using Dart and Flutter.
The APIs Used Can Be Found [Here](https://pokeapi.co/) 
...
- Good Quality Images For Each Pokemon ⚡
- Types , Weaknesses , Next Evolution And Many More Items 😍
...
2) Run The Following Commands :
```git
$ git clone https://github.com/dakshp07/poke-app.git
```

## Images
![First](images/Screenshot_1598103793.png)

![Second](images/Screenshot_1598103901.png)
